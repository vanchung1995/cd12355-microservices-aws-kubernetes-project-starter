...
kubectl create configmap initdbscripts --from-file=create_table=./1_create_tables.sql --from-file=seed_users=./2_seed_users.sql --from-file=seed_tokens=./3_seed_tokens.sql
